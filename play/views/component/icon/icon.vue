  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const iconList = [
        ...
        ['icon-sysMsg2', '系统消息'],
        ['icon-system3', '系统'],
        ['icon-sysNotice1', '系统信息'],
        ['icon-callSys', '外呼系统'],
        ['icon-sysSupervise', '系统监督'],
        ['icon-sysMaintain', '系统维护'],
        ['icon-LANSearch', '局域网搜索'],
        ['icon-monitorSys', '视频监控'],
        ['icon-system4', '系统'],
        ['icon-sysUpdate', '系统更新'],
        ['icon-faceID', '人脸识别'],
      ...
      const iconOther = [
        ...
        ['icon-android', '安卓'],
        ['icon-ios', 'ios'],
        ['icon-targetSetting', '定位设置'],
        ['icon-err', '错误'],
        ['icon-weChat', '微信'],
        ['icon-payTIp', '支付提醒'],
        ['icon-position', '定位'],
        ['icon-addShopCar', '添加购物车'],
        ['icon-collect', '未收藏'],
        ['icon-weChatPay', '微信支付'],
        ['icon-collected', '已收藏'],
        ['icon-weChat1', '微信'],
