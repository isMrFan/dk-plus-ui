<template>
  <div class="isLoading">
    <h3>1.指令v-dk-loading 开启加载中指令组件 默认值:false | true</h3>
    <h3>2.指令dk-loading-text 加载中文案 默认值:加载中...</h3>
    <h3>3.指令dk-loading-color 加载中文案颜色 默认值:#fff</h3>
    <h3>4.指令dk-loading-background 自定义遮罩层背景色 默认值:rgba(0, 0, 0, 0.7)</h3>
