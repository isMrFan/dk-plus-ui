      ...
      <div class="home_content_main_second">
        <div class="home_content_main_second_container">
          ...
          <div
            :class="
              isDark
                ? 'home_content_main_second_container_info home_content_main_second_container_info--dark'
                : 'home_content_main_second_container_info'
            "
          >
...
<style lang="scss" scoped>
  ...
  .btn-dark-bg-border {
    border: 0.4px solid $dark-border-color !important;
  }
