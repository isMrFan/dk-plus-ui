...
function reactify(fn, options) {
  const unrefFn =
    (options == null ? void 0 : options.computedGetter) === false ? unref : resolveUnref
...
function useDateFormat(date, formatStr = 'HH:mm:ss', options = {}) {
  return computed(() =>
    formatDate(normalizeDate(resolveUnref(date)), resolveUnref(formatStr), options)
  )
}
  ...
  const cleanup = [
    ...
    detectIframe &&
      useEventListener(window2, 'blur', event => {
        ...
        const el = unrefElement(target)
        if (
          ((_a2 = window2.document.activeElement) == null ? void 0 : _a2.tagName) ===
            'IFRAME' &&
...
function onLongPress(target, handler, options) {
  ...
  const listenerOptions = {
    capture:
      (_a2 = options == null ? void 0 : options.modifiers) == null ? void 0 : _a2.capture,
...
function useActiveElement(options = {}) {
  ...
  const document2 =
    (_a2 = options.document) != null ? _a2 : window2 == null ? void 0 : window2.document
...
function useCycleList(list, options) {
  ...
  const state = shallowRef(
    (_a2 = options == null ? void 0 : options.initialValue) != null ? _a2 : list[0]
  )
  const index = computed({
    get() {
      ...
      if (index2 < 0)
        index2 =
          (_a22 = options == null ? void 0 : options.fallbackIndex) != null ? _a22 : 0
      return index2
    },
    set(v) {
      set3(v)
...
function useDraggable(target, options = {}) {
  ...
  const start = e => {
    ...
    if (
      ((_a22 = options.onStart) == null ? void 0 : _a22.call(options, pos, e)) === false
    )
      return
  ...
  if (isClient) {
    ...
    useEventListener(target, 'drop', event => {
      ...
      const files = Array.from(
        (_b = (_a2 = event.dataTransfer) == null ? void 0 : _a2.files) != null ? _b : []
      )
...
function useElementSize(target, initialSize = { width: 0, height: 0 }, options = {}) {
  ...
  const isSVG = computed(() => {
    var _a2, _b
    return (_b = (_a2 = unrefElement(target)) == null ? void 0 : _a2.namespaceURI) == null
      ? void 0
      : _b.includes('svg')
  })
  ...
  const execute = async (throwOnFailed = false) => {
    ...
    return new Promise((resolve, reject) => {
      ...
      fetch(
        context.url,
        __spreadProps$32(
          __spreadValues$d(__spreadValues$d({}, defaultFetchOptions), context.options),
          {
            headers: __spreadValues$d(
...
function usePointerSwipe(target, options = {}) {
  ...
  const eventIsAllowed = e => {
    ...
    return (_c =
      (_b =
        (_a2 = options.pointerTypes) == null ? void 0 : _a2.includes(e.pointerType)) !=
      null
        ? _b
...
function useTextSelection(options = {}) {
  ...
  const text = computed(() => {
    var _a2, _b
    return (_b = (_a2 = selection.value) == null ? void 0 : _a2.toString()) != null
      ? _b
      : ''
  })
...
function useTitle(newTitle = null, options = {}) {
  ...
  const title = resolveRef(
    (_a2 = newTitle != null ? newTitle : document2 == null ? void 0 : document2.title) !=
      null
      ? _a2
      : null
  )
  ...
  const { resume, pause } = useRafFn(
    () => {
      ...
      outputVector.value = startVector.map((val, i) => {
        ...
        return (
          val +
          ((_a2 = diffVector[i]) != null ? _a2 : 0) * currentTransition.value(progress)
        )
      })
      if (progress >= 1) {
        pause()
