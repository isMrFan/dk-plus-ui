export default {
  title: 'DK-plus',
  description: 'DK-plus 可在 vue3 web应用程序中快速构建交互界面,DK-plus 是一款灵活、优质的组件库，为开发者、设计师准备。后续会编写H5端和uniApp用的组件库,通过大家的努力,为国内前端事业贡献一份力量',
  base: "/",
  lang: "en-us",
  themeConfig: {
    nav: [
      ...
      { text: 'API', link: '/api/' },
      { text: 'Github', link: 'https://github.com/dk-plus/dk-plus' }
    ],
    sidebar: {
      '/docs/': [
        {
